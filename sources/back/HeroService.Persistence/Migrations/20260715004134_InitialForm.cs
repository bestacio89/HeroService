        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameVersionId = table.Column<Guid>(type: "uuid", nullable: false),
                    SkillId = table.Column<Guid>(type: "uuid", nullable: false),
                    CooldownMultiplier = table.Column<float>(type: "real", nullable: true),
                    ManaCostMultiplier = table.Column<float>(type: "real", nullable: true),
                    DamageMultiplier = table.Column<float>(type: "real", nullable: true),
                    HealingMultiplier = table.Column<float>(type: "real", nullable: true),
                    ShieldMultiplier = table.Column<float>(type: "real", nullable: true),
                    CastTimeMultiplier = table.Column<float>(type: "real", nullable: true),
                    ChannelDurationMultiplier = table.Column<float>(type: "real", nullable: true),
                    CrowdControlDurationMultiplier = table.Column<float>(type: "real", nullable: true),
                    RangeMultiplier = table.Column<float>(type: "real", nullable: true),
                    DateCreated = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    LastModifiedDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: true),
