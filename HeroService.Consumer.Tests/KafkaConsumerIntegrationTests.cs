...
using HeroService.Common.Messaging;
using HeroService.Common.Messaging.Configuration;
using HeroService.Common.Messaging.Delegating;
using HeroService.Common.Messaging.Messages;
using HeroService.Consumer.Services;
using HeroService.Consumer.Tests.config;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;

namespace HeroService.Consumer.Tests
{
